...
Use @. Unfold the Tcells object in the environment to see which symbol to use.
...
#assign idents of Tcells to column in meta data
...
# plot variable features with and without labels (label top 10)
...
* DO cell cycle regression base on data result (want to see it further). Not a standard procedure.
...
*See how well all the principle component split. Getting worse as number grow. Help determine the break point/reasonable split.
...
*parameters like resolution: need to test and see
